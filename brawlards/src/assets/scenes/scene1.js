...
import { getDoor0Asset, getDoor1Asset, getDoor2Asset } from "../objects/DoorFactory.js"
...
const MATERIAL_PROPS = {
  ...
  tubeLight: { roughness: 0.1, emissiveIntensity: 15.0 },  // ✨ MEGA BOOSTED: Stronger tube light
...
const LIGHT_FIXTURE_CONFIG = {
  ...
  tubeRadius: 0.15,
  holderSize: 0.3,
  pointLightIntensity: 7.0,  // ✨ MEGA BOOSTED: Stronger point light from tubes
  pointLightDistance: 35  // ✨ MEGA BOOSTED: Extended light reach
}
...
const DEFAULT_ENV_LIGHTING = {
  ...
  directionalLight: {
    color: "#ffffff",
    intensity: 0,  // ✨ DISABLED: Removed top light source
    position: [0, 30, 0],
    castShadow: false
  },
  pointLights: [],
