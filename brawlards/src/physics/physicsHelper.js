...
export const COLLISION_MASKS = {
    ...
    BALL: COLLISION_GROUPS.STATIC | COLLISION_GROUPS.BALL | COLLISION_GROUPS.PLAYER | COLLISION_GROUPS.RAIL | COLLISION_GROUPS.TRIGGER | COLLISION_GROUPS.CUE,
    // Body chính của Player va chạm với STATIC, BALL và TRIGGER (để kích hoạt event)
    PLAYER: COLLISION_GROUPS.STATIC | COLLISION_GROUPS.BALL | COLLISION_GROUPS.TRIGGER, // Player không còn va chạm với CUE của chính nó
    CUE: COLLISION_GROUPS.BALL, // Cây cơ CHỈ va chạm với bi, không va chạm với bất cứ thứ gì khác
    RAIL: COLLISION_GROUPS.STATIC | COLLISION_GROUPS.BALL | COLLISION_GROUPS.PLAYER, // Table va chạm với BALL, PLAYER, và STATIC
    // Hitbox trigger sẽ được kiểm tra va chạm với PLAYER và BALL (để tạo event cho AI)
    TRIGGER: COLLISION_GROUPS.PLAYER | COLLISION_GROUPS.BALL
};
