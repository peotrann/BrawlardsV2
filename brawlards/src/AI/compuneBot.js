  ...
  update(delta, syncList) {
    ...
    switch (this.state) {
      ...
      case 'disconnecting':
        ...
        console.debug(`[CompuneAI] Disconnect timer: ${this.disconnectTimer.toFixed(1)}s / ${this.disconnectDelay}s`)
      ...
      case 'finished':
        ...
        this.disconnectTimer += delta
        console.debug(`[CompuneAI] Finished timer: ${this.disconnectTimer.toFixed(1)}s / ${this.finishReadDelay}s`)
