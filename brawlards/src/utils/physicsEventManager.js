...
export class PhysicsEventManager {
    ...
    registerBody(body) {
        ...
        body.addEventListener('collide', (event) => {
            ...
            console.log(`[Collision DEBUG] body: ${body.name}, otherBody: ${otherBody.name}, material A: ${body.material?.name}, material B: ${otherBody.material?.name}`);
            ...
            if (entryA?.mesh?.userData.mainColor && entryB?.mesh?.userData.mainColor) {
                console.log(`[Collision] CASE 1: Dynamic collision (spark)`);
            ...
            console.log(`[Collision] isBodyBall: ${isBodyBall}, isOtherTable: ${isOtherTable}`);

            if (isBodyBall && isOtherTable) {
                console.log(`[Collision] CASE 2: Ball vs Table (dust)`);
